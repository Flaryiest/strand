  ...
  const demoSteps = [
    {
      ...
      response:
        "Great! I'll help you plan an amazing weekend in San Francisco. Let me search for the best spots..."
    },
    {
      title: 'AI analyzes thousands of places',
      placeholder: '',
      response:
        'Found 247 restaurants, 89 attractions, and 34 activities that match your preferences.'
    },
    {
      title: 'Get your personalized itinerary',
      placeholder: '',
      response:
        "Here's your custom 2-day San Francisco adventure with optimized routes and timing!"
    }
  ];
  ...
  const features = [
    {
      ...
      description:
        'Our AI analyzes millions of data points to create the perfect itinerary for you.'
    },
    {
      icon: (
        <svg
      ...
      description:
        'Smart routing ensures you spend less time traveling and more time exploring.'
    },
    {
      icon: (
        <svg
      ...
      description:
        'Discover hidden gems and local favorites based on real reviews and ratings.'
    },
    {
      icon: (
        <svg
      ...
      title: 'Collaborative',
      description:
        'Share and plan trips with friends, family, or colleagues seamlessly.'
    }
  ];
      ...
      <div className={styles.contentWrapper}>
        ...
        <section className={styles.heroSection}>
          ...
          <p className={styles.heroSubtitle}>
            Experience how our AI creates personalized travel itineraries in
            seconds.
          </p>
        </section>
                ...
                <div className={styles.responseSection}>
                  <div className={styles.aiResponse}>
                    ...
                    <p className={styles.aiText}>
                      {demoSteps[currentStep].response}
                    </p>
                  </div>
        ...
        <section className={styles.ctaSection}>
          ...
          <p className={styles.ctaSubtitle}>
            Join thousands of travelers creating perfect itineraries with
            Strand.
          </p>
