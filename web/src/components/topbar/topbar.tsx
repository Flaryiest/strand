              ...
              <div className={styles.dropdownMenu}>
                ...
                <div className={styles.menuSection}>
                  <div className={styles.menuItem}>
                    ...
                    <span className={styles.menuValue}>{user?.plan || 'Free'}</span>
                  </div>
                  <div className={styles.menuItem}>
                    <span className={styles.menuLabel}>Credits</span>
                    <span className={styles.menuValue}>{user?.credits || 0}</span>
                  </div>
                </div>
                <div className={styles.menuDivider} />
                <button className={styles.menuButton} onClick={() => navigate('/settings')}>
